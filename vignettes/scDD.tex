...
\begin{itemize}\raggedright
  ...
  \item Loaded via a namespace (and not attached): abind~1.4-3, arm~1.8-6,
    ...
    futile.options~1.0.0, ggplot2~1.0.1, grid~3.2.1, gtable~0.1.2, labeling~0.3,
    ...
    Rcpp~0.12.0, reshape2~1.4.1, scales~0.3.0, spam~1.0-1, splines~3.2.1,
    stringi~0.5-5, stringr~1.0.0, tools~3.2.1
